...
# model_load_path='pretrained/DeCo100' 
...
env_params = {
    'mode': mode,
    # TSPDL 50
    'data_path':f"./data/tspdl50_hard.pkl",
    "solution_path": f"./data/lkh_tspdl50_hard.pkl",
    # 'data_path':f"./data/tspdl50_medium.pkl",
    # "solution_path": f"./data/lkh_tspdl50_medium.pkl",

    
    # TSPDL 100
    # 'data_path':f"./data/tspdl100_hard.pkl",
    # "solution_path": f"./data/lkh_tspdl100_hard.pkl",
    # 'data_path':f"./data/tspdl100_medium.pkl",
    # "solution_path": f"./data/lkh_tspdl100_medium.pkl",
    'sub_path': False,
